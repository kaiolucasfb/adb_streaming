...
id_catalogo INT NOT NULL,
constraint fk_episodio_temporada foreign key (id_temporada) references tb_temporada (id_temporada),
constraint fk_episodio_catalogo foreign key (id_temporada) references tb_catalogo (id_catalogo)
)auto_increment = 1;
*/
...
CONSTRAINT fk_catalogo_idioma FOREIGN KEY (id_catalogo) REFERENCES tb_catalogo (id_catalogo),
CONSTRAINT fk_idioma_catalogo FOREIGN KEY (id_idioma) REFERENCES tb_idioma (id_idioma)
);
